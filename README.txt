...
This code makes use of SciKit-Learn, MatplotLib, Pandas, and Numpy. 
Specific sklearn pages on learning_curve, validation_curve, roc_curve, roc_auc_score, GridSearchCV, StandardScaler, make_pipeline, confusion_matrix, classification_report, train_test_split, MLPClassifier, KNeighborsClassifier, SV, DecisionTreeClassifier, and GradientBoostingClassifier were used as inpiration.